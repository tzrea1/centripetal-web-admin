<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['system:contest-adt:add']"
          type="primary"
          plain
          icon="el-icon-plus"
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['system:contest-adt:edit']"
          type="success"
          plain
          icon="el-icon-edit"
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['system:contest-adt:remove']"
          type="danger"
          plain
          icon="el-icon-delete"
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['system:contest-adt:export']"
          type="warning"
          plain
    ...
    <el-table v-loading="loading" :data="contest-adtList" @selection-change="handleSelectionChange">
