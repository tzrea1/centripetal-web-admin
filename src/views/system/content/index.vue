  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAddPhStudyFile">添加</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleDeletePhStudyFile">删除</el-button>
          </el-col>
        </el-row>
        <el-table ref="phStudyFile" :data="phStudyFileList" :row-class-name="rowPhStudyFileIndex" @selection-change="handlePhStudyFileSelectionChange">
          <el-table-column type="selection" width="50" align="center" />
          <el-table-column label="序号" align="center" prop="index" width="50" />
          <el-table-column label="文件url" prop="fileUrl" width="150">
            <template slot-scope="scope">
              <el-input v-model="scope.row.fileUrl" placeholder="请输入文件url" />
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除党史内容学习活动编号为"' + phStudyIds + '"的数据项？').then(function() {
